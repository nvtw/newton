...
The values below are theoretical upper bounds per shape pair and collision pass
before the shared ``rigid_contact_max`` capacity is applied. Actual counts vary
with pose, margin, and collision settings.

**Primitive and convex-hull pairs**
