...
- Accelerate `SolverSTFLIP` pressure projection with Chebyshev iterations and reduce the default `pressure_iterations` from 80 to 15. Set `pressure_iterations` explicitly to preserve an application-specific iteration budget.
