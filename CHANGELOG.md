...
- Add `newton.geometry.compute_offset_mesh()` for extracting offset surface meshes from any collision shape, and `newton.viewer.SDFMarginMode` viewer toggle to visualize SDF margin/gap wireframes in the GL viewer
