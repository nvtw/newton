...
- Add `--dynamics-solver dvi` and `--target-sim-dt` to the Kamino DR Legs example.
...
- Change the Kamino DR Legs DVI example defaults to use bounded contact recovery and tuned DVI substeps/block solve cadence for faster stable contact.
