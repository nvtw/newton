...
- Change the Kamino DR Legs DVI example defaults to use sparse DVI with bounded contact recovery and tuned direct-bilateral solve cadence for faster stable contact.
