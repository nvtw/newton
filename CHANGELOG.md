...
- Add convex cubic-Bézier solids of revolution through `GeoType.REVOLVED` and `ModelBuilder.add_shape_revolved()`, with analytic GJK/MPR support and packed control radii that require no additional per-shape device storage.
