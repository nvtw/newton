...
- Add opt-in single-phase position-based fluids to `SolverXPBD` for particles marked with `ParticleFlags.FLUID`, including density constraints, viscosity, cohesion, surface tension, vorticity confinement, and velocity damping.
