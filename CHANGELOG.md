...
- Change the Kamino DR Legs DVI example defaults to use sparse DVI with bounded contact recovery, tuned direct-bilateral solve cadence, and a small contact margin for faster stable contact.
