...
- Filter static-static, kinematic-kinematic, and static-kinematic shape contact pairs by default during model finalization and broad-phase collision detection. Static-static pairs are always skipped; set `CollisionPipeline(include_static_kinematic_pairs=True)` when kinematic-kinematic or static-kinematic contacts are required.
