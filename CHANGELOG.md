...
- Accelerate experimental PhoenX G1 PufferMinGRU training with tiled aligned FP32 projections and linear-time recurrent backpropagation that reuses stored forward states.
