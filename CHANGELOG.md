...
- Accelerate experimental PhoenX G1 PufferMinGRU training with tiled aligned FP32 projections, linear-time recurrent backpropagation that reuses stored forward states, and deterministic split-K weight gradients.
