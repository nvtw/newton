...
- Add opt-in `ViewerGL` simulation/render overlap to the common example runner, allowing CUDA-graph-compatible physics stepping on a nonblocking stream while OpenGL renders a snapshotted state.
