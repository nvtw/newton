...
_DVI_QUALITY_TESTS = (
    ...
    "test_00c_sparse_projection_uses_padded_bilateral_vector_size",
    ...
    "test_03d1_sparse_dvi_honors_per_world_bilateral_intervals",
    ...
    "test_03g3_dvi_inequality_coloring_groups_contact_pairs",
    "test_03g4_dvi_inequality_coloring_ignores_immovable_bodies",
    "test_03h_dvi_canonical_contact_solution_metrics",
    "test_03i_dvi_coldstart_is_repeatable",
    "test_03i_dvi_stationary_contact_patch_avoids_tangent_self_stress",
    "test_03ia_dvi_decays_tangential_but_not_normal_warmstarts",
    "test_03ib_dvi_balances_sticking_friction_across_contact_patch",
    "test_03ic_dvi_excludes_penetration_recovery_from_friction_load",
    ...
    "test_03j2_sparse_dvi_refreshes_tangent_cross_cache",
    ...
    "test_08aa_public_solver_preserves_immovable_joint_anchor_with_dvi",
    "test_08ab_public_solver_treats_kinematic_bodies_as_immovable",
    "test_08c_dvi_zero_friction_preserves_tangent_momentum",
    "test_08ca_dvi_penetration_recovery_does_not_lock_tangent_motion",
