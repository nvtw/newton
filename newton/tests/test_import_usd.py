...
"""
    ...
    def test_margin_parsing(self):
        """Test that margin is parsed correctly from USD."""
        from pxr import Usd, UsdGeom, UsdPhysics
        ...
        # Create another collider without margin (should use default)
        ...
        # Import the USD
        builder = newton.ModelBuilder()
        builder.default_shape_cfg.margin = 0.01  # set a known default
        result = builder.add_usd(stage)
        model = builder.finalize()

        # Verify margin was parsed correctly
        ...
        margin1 = model.shape_margin.numpy()[shape1_idx]
        self.assertAlmostEqual(margin1, 0.05, places=4)

        # Collider2 should have the default value
        margin2 = model.shape_margin.numpy()[shape2_idx]
