    ...
    for key, value in ret_dict.items():
        if key in {
            ...
            for xpath, shape_spec in zip(paths, shape_specs, strict=False):
                ...
                margin = R.get_value(prim, prim_type=PrimType.SHAPE, key="margin", verbose=verbose)
                if margin == float("-inf"):
                    margin = builder.default_shape_cfg.margin
                ...
                shape_params = {
                    ...
                    "cfg": ModelBuilder.ShapeConfig(
                        ...
                        gap=usd.get_float_with_fallback(
                            prim_and_scene, "newton:contact_gap", builder.default_shape_cfg.gap
                        ),
                        margin=margin,
