...
def accumulate_body_body_contacts_per_body(
    ...
    while i < num_contacts:
        ...
        margin = rigid_contact_margin0[contact_idx] + rigid_contact_margin1[contact_idx]
...
def update_duals_body_body_contacts(
    ...
    margin_total = rigid_contact_margin0[idx] + rigid_contact_margin1[idx]
    penetration = wp.max(0.0, margin_total - dist)
