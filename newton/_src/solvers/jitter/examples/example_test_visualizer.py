...
# decorates with :func:`newton._src.solvers.jitter.examples.scene_registry.scene`.
...
# dropped on switch.
#
# Run: ``python -m newton._src.solvers.jitter.examples.example_test_visualizer``
#
...
from newton._src.solvers.jitter.examples.scene_registry import (
    Scene,
    discover_scenes,
    registered_scenes,
)
    ...
    def __init__(self, viewer, args):
        ...
        if not scenes:
            raise RuntimeError(
                ...
                "@newton._src.solvers.jitter.examples.scene_registry.scene"
            )
