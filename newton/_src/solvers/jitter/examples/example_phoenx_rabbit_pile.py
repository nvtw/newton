...
#
# Run:  python -m newton._src.solvers.jitter.examples.example_phoenx_rabbit_pile
###########################################################################
...
from newton._src.solvers.jitter.body import body_container_zeros
...
class Example:
    ...
    def __init__(self, viewer, args):
        ...
        if not self.device.is_cuda:
            raise RuntimeError(
                "example_phoenx_rabbit_pile requires CUDA (SDF narrow phase is CUDA-only)."
            )
