...
Example:
    ...
    >>> from newton._src.solvers.jitter.constraints.constraint_ball_socket import BallSocketData
    >>> from newton._src.solvers.jitter.helpers.data_packing import offset_of, dword_offset_of, num_dwords
