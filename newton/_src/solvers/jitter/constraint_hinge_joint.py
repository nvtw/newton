...
from newton._src.solvers.jitter.data_packing import dword_offset_of
...
def hinge_joint_initialize_kernel(
    ...
    :func:`~newton._src.solvers.jitter.constraint_ball_socket.ball_socket_initialize_kernel`,
    :func:`~newton._src.solvers.jitter.constraint_hinge_angle.hinge_angle_initialize_kernel`,
    and
    :func:`~newton._src.solvers.jitter.constraint_angular_motor.angular_motor_initialize_kernel`,
