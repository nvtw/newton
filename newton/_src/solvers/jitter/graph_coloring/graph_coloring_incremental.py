...
Companion to :class:`newton._src.solvers.jitter.graph_coloring.graph_coloring.ContactPartitioner`
...
from newton._src.solvers.jitter.helpers.scan_and_sort import scan_variable_length
