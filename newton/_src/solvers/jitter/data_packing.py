...
Example:
    ...
    >>> from newton._src.solvers.jitter.constraint_ball_socket import BallSocketData
    >>> from newton._src.solvers.jitter.data_packing import offset_of, dword_offset_of, num_dwords
