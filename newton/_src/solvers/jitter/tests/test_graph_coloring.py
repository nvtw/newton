...
from newton._src.solvers.jitter.graph_coloring.graph_coloring import (
    MAX_BODIES,
    ContactPartitioner,
    ElementInteractionData,
    maximal_independent_set_partitioning,
)
from newton._src.solvers.jitter.graph_coloring.graph_coloring_incremental import IncrementalContactPartitioner
