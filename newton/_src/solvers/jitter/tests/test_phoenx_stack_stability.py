...
1. **Tall tower** (40 layers x 4 planks) -- analogous to
   :mod:`newton._src.solvers.jitter.examples.example_phoenx_tower`.
...
class TestPhoenXTallTowerHoldsAtRest(unittest.TestCase):
    ...
    Scaled-down version of ``example_phoenx_tower``: 10 layers of 4
    ...
    def test_tower_stays_stacked(self) -> None:
        ...
        cube_ids: list[int] = []
        # Single-column 6-cube tower -- the example_phoenx_tower
