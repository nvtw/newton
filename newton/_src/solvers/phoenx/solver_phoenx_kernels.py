...
def _phoenx_apply_forces_and_gravity_kernel(
    ...
    bodies.velocity_prev_substep[i] = bodies.velocity[i]
    bodies.angular_velocity_prev_substep[i] = bodies.angular_velocity[i]
    if bodies.motion_type[i] != MOTION_DYNAMIC:
        ...
        if bodies.motion_type[i] == MOTION_STATIC:
            ...
            bodies.velocity_prev_substep[i] = wp.vec3f(0.0, 0.0, 0.0)
            bodies.angular_velocity_prev_substep[i] = wp.vec3f(0.0, 0.0, 0.0)
        return
