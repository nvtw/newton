...
class DirectEqualitySystem:
    ...
    def bind_d6_inequalities(self, constraints, joint_idx_to_cid: np.ndarray) -> None:
        """Expose common D6 axis rows to the colored unilateral solver."""
        data, counts = _build_d6_inequality_data(self.model, joint_idx_to_cid)
        constraints.d6 = data
        self.d6_inequality_count = counts
