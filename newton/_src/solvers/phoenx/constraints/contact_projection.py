...
def _make_contact_project_normal_delta_load(has_soft_contact_pd: bool):
    @wp.func
    def impl(
        cc: ContactContainer,
        k: wp.int32,
...
contact_project_normal_delta_load = _make_contact_project_normal_delta_load(True)
contact_project_normal_delta_load_no_soft_pd = _make_contact_project_normal_delta_load(False)


@wp.func
def contact_project_tangent_delta(
    cc: ContactContainer,
    k: wp.int32,
    ...
    """Solve the coupled tangent block after the normal row has been updated."""
