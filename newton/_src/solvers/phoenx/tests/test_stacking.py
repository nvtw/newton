...
* Mini circular tower (3 layers, 6 planks per ring): miniature of
  the :mod:`example_tower` scene, shape and mass ratios
...
class _PhoenXScene:
    ...
    def __init__(
        ...
        *,
        ...
        self.colored_contact_rows = bool(colored_contact_rows)
    ...
    def finalize(self) -> None:
        ...
        self.world = PhoenXWorld(
            ...
            colored_contact_rows=self.colored_contact_rows,
...
class TestPhoenXSolverStacking(unittest.TestCase):
    ...
    def test_multi_world_cached_prepare_stride_three_rests_on_plane(self) -> None:
        """Stride-3 cached prepare works on the multi-world fast-tail path."""
        scene = _PhoenXScene(
            substeps=4,
            solver_iterations=8,
    ...
    def test_mini_circular_tower(self) -> None:
        ...
        Geometry scaled down from :mod:`example_tower` but
