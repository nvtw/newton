...
| D6 inequality consolidation | Remove the legacy three-axis BALL/UNIVERSAL angular-limit block after all D6 bounds moved to common six-axis rows | Deletes duplicate adapter arrays, initialization arguments, preparation, warm-start, and iteration code. Common rows retain paired impulses and support limits, speed caps, and friction on the same axes. |
