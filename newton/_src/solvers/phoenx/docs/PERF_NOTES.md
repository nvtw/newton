...
| D6 inequality ownership | Build common D6 rows independently of the direct equality system | Projected full-coordinate modes now retain D6 limits and live property updates without falling back to mode-specific scalar rows. |
