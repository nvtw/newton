...
def solve_body_contact_positions(
    ...
    gap_total = contact_gap0[tid] + contact_gap1[tid]
    n = -contact_normal[tid]
    d = wp.dot(n, bx_b - bx_a) - gap_total
    ...
    # linear friction
    if mu > 0.0:
        # add on displacement from surface offsets, this ensures we include any rotational effects due to gap from feature
