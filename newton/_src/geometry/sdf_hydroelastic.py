...
class SDFHydroelastic:
    ...
    def __init__(
        ...
        with wp.ScopedDevice(device):
            ...
            # Each level's output coords/pairs become the next level's input.
            # Counts are scalar per level; coords/pairs are sized per level.
            ...
            if self.config.reduce_contacts:
                ...
                # Always use inline reduction for reduced hydroelastic contacts.
                use_inline = True
    ...
    def _generate_contacts(
        ...
        Writes to one of:
        - inline reducer slots (reduce_contacts=True)
