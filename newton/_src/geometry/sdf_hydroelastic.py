...
class HydroelasticSDF:
    ...
    def launch(
        ...
        Args:
            ...
            shape_margin: Contact margin for each shape.
        ...
        self._find_iso_voxels(shape_sdf_data, shape_transform, shape_margin)

        if self.config.reduce_contacts:
            self._generate_contacts(shape_sdf_data, shape_transform, shape_margin)
...
def get_decode_contacts_kernel(margin_contact_area: float = 1e-4, writer_func: Any = None):
    ...
    def decode_contacts_kernel(
        ...
        for tid in range(offset, num_contacts, grid_size):
            ...
            contact_data.gap_a = 0.0
            contact_data.gap_b = 0.0
