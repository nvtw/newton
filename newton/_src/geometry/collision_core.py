...
def create_compute_gjk_mpr_contacts(
    ...
    def compute_gjk_mpr_contacts(
        ...
        Args:
            ...
            rigid_contact_gap: Contact margin for rigid bodies
            shape_a: Index of shape A
            shape_b: Index of shape B
            margin_a: Thickness of shape A
            margin_b: Thickness of shape B
        ...
        contact_template.gap = rigid_contact_gap
        ...
        if wp.static(ENABLE_MULTI_CONTACT):
            wp.static(create_solve_convex_multi_contact(support_map, writer_func, post_process_contact))(
                ...
                data_provider,
                rigid_contact_gap + radius_eff_a + radius_eff_b,
    ...
    def find_contacts(
        ...
        if is_infinite_plane_a:
            ...
            shape_data_a, pos_a_adjusted = convert_infinite_plane_to_cube(
                shape_data_a, quat_a, pos_a, pos_b, bsphere_radius_b + rigid_contact_gap
            )
        ...
        if is_infinite_plane_b:
            ...
            shape_data_b, pos_b_adjusted = convert_infinite_plane_to_cube(
                shape_data_b, quat_b, pos_b, pos_a, bsphere_radius_a + rigid_contact_gap
            )
...
def mesh_vs_convex_midphase(
    ...
    margin_vec = wp.vec3(rigid_contact_gap, rigid_contact_gap, rigid_contact_gap)
