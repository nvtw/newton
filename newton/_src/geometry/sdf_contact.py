...
def create_narrow_phase_process_mesh_mesh_contacts_kernel(
    ...
    def mesh_sdf_collision_kernel(
        ...
        Args:
            ...
            geom_data: Array of vec4 containing scale (xyz) and gap (w) for each shape
        ...
        for pair_idx in range(block_id, pair_count, total_num_blocks):
            ...
            margin = shape_margin[pair[0]] + shape_margin[pair[1]]
            ...
            for mode in range(2):
                ...
                # Shape gap is a runtime collision property.
                triangle_mesh_gap = scale_data_tri[3]
                sdf_mesh_gap = scale_data_sdf[3]
                ...
                contact_threshold = margin + triangle_mesh_gap + sdf_mesh_gap
                ...
                while selected_triangles[tri_capacity + 1] < num_tris:
                    ...
                    if has_triangle:
                        ...
                        if dist < contact_threshold:
                            ...
                            contact_data.gap_a = shape_data[pair[0]][3]
                            contact_data.gap_b = shape_data[pair[1]][3]
