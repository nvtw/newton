...
def create_export_hydroelastic_reduced_contacts_kernel(
    ...
    def export_hydroelastic_reduced_contacts_kernel(
        ...
        for i in range(tid, num_active, total_num_threads):
            ...
            margin_a = shape_margin[shape_a_first]
            margin_b = shape_margin[shape_b_first]
    ...
    **Usage Pattern:**
    ...
    Example:
        ...
        .. code-block:: python
            ...
            reduction.export(shape_margin, shape_transform, writer_data, grid_size)
    ...
    def export(
        ...
        Args:
            shape_margin: Per-shape contact margin (dtype: float).
            shape_transform: Per-shape world transforms (dtype: wp.transform).
    ...
    def reduce_and_export(
        ...
        self.export(shape_margin, shape_transform, writer_data, grid_size)
