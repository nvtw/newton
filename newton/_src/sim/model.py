...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        self._shape_hfield_fallback_mesh_refs = []
        """Internal references to generated fallback meshes to keep Warp mesh IDs alive."""
        ...
        self.shape_hfield_fallback_mesh_source_ptr = None
        """Collision source pointer with heightfield mesh fallback, shape [shape_count], uint64.

        For non-heightfield shapes this mirrors ``shape_source_ptr``.
        For heightfields this stores a generated mesh pointer used by mesh-based fallback paths.
        """
        ...
        self.attribute_frequency["shape_hfield_fallback_mesh_source_ptr"] = Model.AttributeFrequency.SHAPE
