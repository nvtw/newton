...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        For heightfield shapes, this stores a generated mesh pointer used by mesh-based fallback paths
        (mesh-mesh, mesh-plane, soft contacts). The native heightfield collision kernel uses
        ``shape_heightfield_data`` instead.
        """
