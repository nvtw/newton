...
class Model:
    ...
    _CORE_ATTRIBUTE_SPECS: ClassVar[dict[str, AttributeSpec]] = {
        ...
        "joint_gear": AttributeSpec(AttributeFrequency.JOINT_DOF),
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        """Packed scaled centers and bounding radii, shape [total_edge_count, 4] [m]."""
        self.mesh_edge_halves: wp.array[wp.vec4] | None = None
        """Packed scaled half-vectors [m] and endpoint ownership, shape [total_edge_count, 4]."""
        ...
        :class:`~newton.solvers.SolverPhoenX` direct maximal mode supports exact
        generalized armature on revolute and prismatic joints. The effective
        joint-space inertia is reflected through :attr:`joint_gear` squared.
        """
