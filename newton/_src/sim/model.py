...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        self.shape_mesh_query_type: wp.array[wp.int32] | None = None
        """Mesh sign query strategy, shape [shape_count], int."""
        ...
        self.attribute_frequency["shape_mesh_query_type"] = Model.AttributeFrequency.SHAPE
