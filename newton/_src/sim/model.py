...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        For heightfield shapes, this stores the generated fallback :class:`~newton.Mesh`
        (with the original :class:`~newton.Heightfield` accessible via
        ``mesh._heightfield_source``).
        """
        ...
        For heightfield shapes, this stores the pointer to a generated fallback
        triangle mesh so that the narrow phase treats heightfields identically to
        regular meshes for all collision routes.
        """
