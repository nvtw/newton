...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        self._shape_mesh_query_type: wp.array[wp.int32] | None = None
        """Internal mesh sign-query strategy for collision kernels, shape [shape_count], int32."""
        ...
        self.attribute_frequency["_shape_mesh_query_type"] = Model.AttributeFrequency.SHAPE
