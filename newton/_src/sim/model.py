...
class Model:
    ...
    _CORE_ATTRIBUTE_SPECS: ClassVar[dict[str, AttributeSpec]] = {
        ...
        "shape_support_data": AttributeSpec(AttributeFrequency.SHAPE, requires_empty_sentinel=True),
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        self.shape_support_data: wp.array[wp.vec4i] | None = None
        """Per-shape compact convex support metadata: LUT, offset, neighbor starts, and resolution."""
        self.convex_support_lut: wp.array[wp.int32] | None = None
        """Packed octahedral directional seed tables shared by convex geometries."""
        self.convex_support_vertex_offsets: wp.array[wp.int32] | None = None
        """Packed CSR vertex-neighbor offsets shared by convex geometries."""
        self.convex_support_neighbors: wp.array[wp.int32] | None = None
