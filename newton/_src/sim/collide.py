...
class CollisionPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        with wp.ScopedDevice(device):
            ...
            self.geom_transform = wp.zeros(shape_count, dtype=wp.transform, device=device, requires_grad=requires_grad)
    ...
    def collide(
        ...
        *,
        ...
        # AABB computation and broad phase use enable_backward=False so they never
        # generate adjoint code.  The narrow phase primitive kernel IS differentiable
        # (routing logic lives in a wp.func(enable_backward=False) helper).
