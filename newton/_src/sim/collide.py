...
class CollisionPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        self._soft_face_fallback_tids = wp.empty(len(self.soft_face_rigid_pairs), dtype=wp.int32, device=model.device)
        self._soft_face_fallback_count = wp.zeros(1, dtype=wp.int32, device=model.device)
        ...
        *,
        ...
        if self.enable_rigid_soft_full_surface_contact and state.particle_q:
            launch_soft_ef_contacts(
                ...
                face_fallback_tids=self._soft_face_fallback_tids,
                face_fallback_count=self._soft_face_fallback_count,
