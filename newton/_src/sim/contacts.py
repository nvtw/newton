    ...
    def __init__(
        ...
        Args:
            ...
            requires_grad: Whether contact arrays require gradients for differentiable
                ...
                offset0, offset1, normal) are allocated with gradients so that the
                differentiable narrow phase primitive kernel can propagate gradients
                through contact geometry.  Soft contact arrays (body_pos, body_vel,
                normal) are also allocated with ``requires_grad``.
        ...
        with wp.ScopedDevice(device):
            ...
            # rigid contacts — geometry arrays get requires_grad for differentiable contacts
