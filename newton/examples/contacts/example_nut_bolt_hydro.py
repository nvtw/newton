...
def load_mesh_with_sdf(
    ...
    mesh.build_sdf(
        ...
        margin=shape_cfg.margin if shape_cfg and shape_cfg.margin is not None else 0.005,
...
class Example:
    def __init__(
        ...
        main_scene.default_shape_cfg.margin = 0.01
    ...
    def _build_nut_bolt_scene(self) -> newton.ModelBuilder:
        ...
        world_builder.default_shape_cfg.margin = 0.01 * self.scene_scale
    ...
    def _build_gears_scene(self) -> newton.ModelBuilder:
        ...
        world_builder = newton.ModelBuilder()
        world_builder.default_shape_cfg.margin = 0.003 * self.scene_scale
