...
<table>
  ...
  <tr>
    <td colspan="3"><h3>Phoenx Examples</h3></td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/phoenx/example_phoenx_kpm_fr_volume.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_phoenx_kpm_fr_volume.jpg" alt="Phoenx KPM-FR Volume">
      </a>
    </td>
    <td align="center" width="33%">
    </td>
  ...
  <tr>
    <td align="center" width="33%">
      <code>python -m newton.examples phoenx_kpm_fr_volume</code>
    </td>
    <td align="center" width="33%">
    </td>
    <td align="center" width="33%">
