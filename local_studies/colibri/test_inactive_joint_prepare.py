"""Compare live block-joint transitions with the local inactive-row shortcut."""
...
import newton
from local_studies.colibri.inactive_joint_prepare import prepare
...
def run(fast, prismatic, split):
    kernels.joint_constraint_prepare_inequality = prepare if fast else joint._joint_constraint_prepare_inequality_full
