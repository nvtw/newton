"""Local two-body native joint-conditioned control with combined friction fixes."""
...
def main():
    ...
    def construct(solver, model, *positional, **options):
        ...
        assert options["substeps"] == 30 and options["solver_iterations"] == 1 and options["sor_boost"] == 1.0
