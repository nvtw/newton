...
from local_studies.colibri.prototype_normal_first import _make_contact_iterate_at as _make_normal_first
...
def _make_sweep(*, fast, bias, pd):
    factory = _make_normal_first if fast else _make_contact_iterate_at
    iterate = factory(
        cloth_support=False,
        ...
        **({} if fast else {"normal_first": False}),
    )
