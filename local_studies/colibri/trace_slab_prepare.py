...
"""Record the first public-constructor slab preparation differences without graph capture."""
...
from local_studies.colibri import slab_adapter
...
from local_studies.colibri.slab_parallel_prepare import install
...
restore_envelope = install_conservative_mesh_candidates()
...
restore_envelope()
example.solver._slab_reference = slab_adapter.install(example.solver, colors_per_slab=8, gpu=True)
