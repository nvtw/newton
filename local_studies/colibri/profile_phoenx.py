...
def main():
    ...
    if args.contact_chunk_size < 0 or args.warmup < 0:
        parser.error("Chunk size and warmup must be nonnegative")
    if args.contact_chunk_size and not args.fused:
        parser.error("Contact chunking requires --fused")
    if args.contact_chunk_size:
